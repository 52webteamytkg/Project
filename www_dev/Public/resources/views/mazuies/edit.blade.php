...
@section('main_content')
  <!-- edit area -->
  <form class="container" action="{{ route('mauzimeshi.update',['post'=>$post->id])}}"method="POST" enctype="multipart/form-data">
      @csrf
      <div class="container">
          <div class="row">
                ...
                <!-- 画像 -->
                  ...
                  <!-- 画像アップ -->
                    <div class="form-group">
                        ...
                        <input type="file" name="img_url" class="form-control" id="img_url" name="icon">
                    </div>
                  <!-- コメント -->
          ...
          <div class="container">
            <form class="form-edit" style="margin-left: 250px;">
                <div class="form-label-group">
                    <input type="id" id="inputId" class="form-control" placeholder="ID" required autofocus name="name">
